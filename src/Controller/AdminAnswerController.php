...
{
    /**
     * @Route("/admin/answer", name="admin_answer_index")
     */
    ...
    /**
     * @Route("/admin/answer/new", name="admin_answer_new", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/admin/answer/{id}", name="admin_answer_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/admin/answer/{id}/edit", name="admin_answer_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/admin/answer/{id}", name="admin_answer_delete", methods={"DELETE"})
     */
